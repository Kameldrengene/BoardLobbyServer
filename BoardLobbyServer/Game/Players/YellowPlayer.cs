...
namespace BoardLobbyServer.Game.Players
{
    ...
    public class YellowPlayer : Player
    {
        ...
        public override void initPieces(Field field)
        {
            ...
            Piece piece1 = new Piece(Color.YELLOW, this, field);
            Piece piece2 = new Piece(Color.YELLOW, this, field);
            Piece piece3 = new Piece(Color.YELLOW, this, field);
            Piece piece4 = new Piece(Color.YELLOW, this, field);
            pieces.Add(piece1);
            pieces.Add(piece2);
            pieces.Add(piece3);
            pieces.Add(piece4);
